...
collect.py
  ...
  │   │
  │   ├─ get_marine_weather_open_meteo() ──► Open-Meteo Marine API
  │   │   └─ Vagues + houle
  │   │
  │   └─ get_weather_data_open_meteo() ──► Open-Meteo ERA5 API
  │       └─ Météo générale
  │
...
### Open-Meteo ERA5 (Météo générale)
...
- Open-Meteo: API stable, gratuit, documenté
...
Mais **ce n'est pas nécessaire** - Open-Meteo suffit!
