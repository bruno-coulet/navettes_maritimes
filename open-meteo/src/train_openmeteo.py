"""
Train RandomForest model on Open-Meteo merged data.
...
# === CONFIG ===
DATA_PATH = Path(__file__).resolve().parents[1] / "data" / "processed" / "training_merged.parquet"
ARTIFACTS_DIR = Path(__file__).resolve().parents[1] / "artifacts"
MODEL_PATH = ARTIFACTS_DIR / "model_openmeteo_v2.pkl"
FEATURES_PATH = ARTIFACTS_DIR / "features_openmeteo_v2.json"

# Features Open-Meteo pures (identique à v2)
OPENMETEO_FEATURES = [
    'wave_height_max',
...
def prepare_features(df):
    """Prépare les features Open-Meteo."""
...
def save_artifacts(model, metrics, feature_names, model_path=MODEL_PATH, features_path=FEATURES_PATH):
    ...
    features_info = {
        ...
        'source': 'Open-Meteo (merged with Maritime annulations)',
...
def main():
    """Pipeline complet."""
    print("="*70)
    print("TRAINING: RandomForest on Open-Meteo Data")
    print("="*70)
